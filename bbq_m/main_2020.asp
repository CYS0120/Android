	...
	<div class="container">
		...
		<article class="content">
			...
			<div class="section-wrap">
				<section class="section section_info pad-t113" style="background:#fff"><!--background:url('<%=SERVER_IMGPATH%>/main/<%=MAIN_IMG%>') no-repeat center top;-->
					...
					<div class="section-body inner">
						...
						<div class="flexslider">
							<ul class="slides spot_li">
								<li class="flex-active-slide" style="background-image:url('/images/main/bba_main_20200106.jpg');"></li>
								<li class="" style="background-image:url('/images/main/bba_main_191224.jpg');"></li>
								<li class="" style="background-image:url('/images/main/mainVisual1.jpg');"></li>
								<li class="" style="background-image:url('/images/main/mainVisual2.jpg');"></li>
								<li class="" style="background-image:url('/images/main/mainVisual3.jpg');"></li>
							</ul>
						</div>
						...
						<div class="main_con">
							<a href="/main_menuList.asp" >
								<ul class="main_order">
									<li>주문</li>
									<li><img src="/images/main/icon_m_order.png"></li>
									<li>하기</li>
								</ul>
							</a>
							<ul class="main_other">
								...
								<li>
									<a href="/menu/menuView.asp?midx=<%=brs("menu_idx")%>">
										<img src="/images/main/icon_m_reco.png">
										<p>추천메뉴</p>
									</a>
								</li>
								<li>
									<a href="javascript:openJoin();">
										<img src="/images/main/icon_m_member.png">
										<p>멤버쉽가입</p>
									</a>
								</li>
							</ul>
					...
					<div class="section-header">
						<div class="event_swiper swiper-container">
							<ul class="swiper-wrapper">
								<li class="swiper-slide"><img src="/images/event/190930_mo.jpg" alt=""></li>
								<li class="swiper-slide"><img src="/images/event/190909_mo2.png" alt=""></li>
							</ul>
						</div>
					</div>
					//Main Event-->		

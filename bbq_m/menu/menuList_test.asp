...
<div class="wrapper">
	...
	<div class="container">
		...
		<article class="content">
			...
			<!--#include virtual="/includes/address_20200330_new.asp"-->
...
'						menu_str_arr = array("세계 치킨 시리즈", "순수하게 후라이드", "다양하게 양념", "섞어먹자 반반", "구워먹는 비비큐")
'					else 
'						menu_idx_arr = array()
'						menu_str_arr = array()
'
...
'
'							if category_idx = "102" then menu_str_arr = array("세계 치킨 시리즈")
...
'					end if 
					...
					menu_str_arr = array("인기메뉴", "세계 치킨 시리즈", "순수하게 후라이드", "다양하게 양념", "섞어먹자 반반", "구워먹는 비비큐", "사이드 메뉴")

		...
		%>
		<!-- Aside Menu -->
		<aside id="aside_menu_div" class="aside aside-menu <%If CheckLogin() Then%>login<%End If%>" style="display:block; width:0px; height:0px;">
				...
				<div class="aside-body">
					...
					<nav class="aside-lnb">
						<ul class="lnb">
							...
							<li class="phoneOrder"><a href="tel:1588-9282">전화주문<br><span>1588-9282</span></a></li>
					...
					<dl class="Aside_footer">
						...
						<dd>서울시 송파구 중대로 64(문정동)<span>/</span>대표자 : 윤경주</dd>

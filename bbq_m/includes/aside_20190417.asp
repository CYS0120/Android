<%
	Dim pointBalance, couponHoldList, cardOwnList, restPoint, couponCount, cardCount
	restPoint = 0
	couponCount = 0
	cardCount = 0
				...
				<div class="aside-header">
					...
					<ul class="myInfo">
						<li onclick="location.href='/mypage/couponList.asp';">
							<dl>
								<dt>쿠폰</dt>
								<dd><span><%=couponCount%></span>장</dd>
							</dl>
						</li>
						<li onclick="location.href='/mypage/mileage.asp';">
							<dl>
								<dt>포인트</dt>
								<dd><span><%=FormatNumber(restPoint,0)%></span>P</dd>
							</dl>						
						<li onclick="location.href='/mypage/cardList.asp';">
							<dl>
								<dt>카드</dt>
								<dd><%=FormatNumber(cardCount,0)%>장</dd>
							</dl>
						</li>
					</ul>
				</div>
					...
					<div class="aside-quick-box">
						...
						<ul class="aside-quick">
							...
							<li>
								...
								<a href="#;" onclick="javascript:showAlertMsg({msg:'준비중입니다.'});">
...
<%	Else %>
								<a href="javascript:void(0);" onclick="javascript:openLogin();">
<%	End If %>
							<!--	<a href="javascript:void(0);" onclick="javascript:lpOpen('.lp_Couponinfo');">	-->
...
%>					
						<div class="aside-barcord">
							<div class="in-sec">
								<%Call Barcode(Session("userCard"),100,0,True)%>
							</div>
						</div>
			...
			<div class="aside-container">		
				...
				<div class="aside-body">
					<ul class="familyBrand">
                        ...
                        <li><a href="<%=SITE_DOMAINURL_BBQMALL%>" target="_blank"><img src="/images/common/ico_brandMenu02.png" alt=""><span>비비큐몰</span></a></li>
					</ul>
				</div>
				<!--// Aside Body -->
				<!-- Aside Close Button -->

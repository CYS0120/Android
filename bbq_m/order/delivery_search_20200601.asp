...
//		$('#addr_img_obj_'+ addr_idx).prop('src', "/images/common/ui_radio_on.png");
	...
	<div class="container">
		...
		<article class="content">
			...
			<!-- Layer Popup : 배달지 입력 -->
			<div id="LP_addShipping" class="lp_addShipping">
				...
				<div class="lp-container">
					...
					<div class="lp-content">
							...
							<dl class="regForm">
								<dd>
									<div>
										...
										<button type="button" onClick="javascript:showPostcode();" class="btn btn-sm btn-gray btn_post">주소 찾기</button>
									</div>
									...
									<div class="mar-t10"><input type="text" name="address_detail" id="address_detail" maxlength="30" class="w-100p"></div>
								</dd>
							</dl>
						</div>
						<% If instr(Request.ServerVariables("HTTP_USER_AGENT"), "bbqAOS") > 0 Then %>
						...
						<div class="btn-wrap two-up mar-t20">
							...
							<button type="button" onClick="location.href='/order/delivery.asp?order_type=<%=order_type%>' " class="btn btn_middle btn-gray">취소</button>

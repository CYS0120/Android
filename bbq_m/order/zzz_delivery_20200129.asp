...
%>
							...
							<div class="btn-wrap">
								<button type="button" class="btn btn_small btn-gray" onclick="go_addr()">주소 변경</button>
							</div>

							<div class="selection_btn">
								<a href="javascript:;" onclick="lpOpen('.lp_addShipping')" class="btn-red btn_big">매장 찾기</a>
							</div>
						...
						<div class="pickup-wrap"<%If order_type = "P" Then%> style="display:none"<%End If%>>
							...
							<div class="btn-wrap inner mar-t40">
								<button type="button" class="btn btn_small btn-gray" onclick="location.href='/order/out_search.asp'">포장매장 찾기</button>
							</div>
						</div>
						<!--// 포장매장 매장 -->							

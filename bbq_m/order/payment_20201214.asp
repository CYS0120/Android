...
%>
	...
	<script type="text/javascript">
        ...
        if(sessionStorage.getItem("M_1246_0") || sessionStorage.getItem("M_1247_0") || sessionStorage.getItem("M_1248_0") || sessionStorage.getItem("M_1249_0")){
			...
			// $("#nowDate").val(new Date().toISOString().substring(0, 10));
			
			// document.getElementById("deliver_event").style.display = "block";
            // document.getElementById("event_book").style.display = "block";
            // document.getElementById("deliver_addr").style.display = "none";
            // document.getElementById("payment_later").style.display = "none";
            // document.getElementById("payment_cash").style.display = "none";
            // document.getElementById("payment_text").style.display = "block";
            // document.getElementById("payment_paycoin").style.display = "none";
            // document.getElementById("payment_phone").style.display = "none";
            // document.getElementById("payment_payco").style.display = "none";
            // document.getElementById("payco_txt").style.display = "none";
            ...
            // document.getElementById('nowTime').value = (nowHour+1) + ":" + nowMinute;
            ...
            // document.getElementById("deliver_event").style.display = "none";
            // document.getElementById("event_book").style.display = "none";
            // document.getElementById("deliver_addr").style.display = "block";
            // document.getElementById("payment_later").style.display = "block";
            // document.getElementById("payment_cash").style.display = "block";
            // document.getElementById("payment_text").style.display = "none";
            // document.getElementById("payment_paycoin").style.display = "block";
            // document.getElementById("payment_phone").style.display = "block";
            // document.getElementById("payment_payco").style.display = "block";
            // document.getElementById("payco_txt").style.display = "block";
            // document.getElementById("coupon_area").style.display = "block";
        }
    </script>

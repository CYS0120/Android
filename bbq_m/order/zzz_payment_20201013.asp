...
var adult_chk_ok = $("#Danal_adult_chk_ok"); // 실명인증을 했다면 Y로 변경
	...
	<div class="container">
		...
		<article class="content inbox1000">
				...
				<section class="section section_orderDetail" id="payment_list">
					...
					<%
						...
						<%
							...
							If adult_yn = "Y" Then 
								adult_Y_Price = adult_Y_Price + ( vMenuPrice * Order_qty )
							Else 
			...
			<div class="btn-wrap one mar-t20" id="Danal_adult_chk_button">
					<button type="button" onclick="javascript:member_alcohol_chk();" class="btn btn_big btn-red">실명인증</button>
			</div>

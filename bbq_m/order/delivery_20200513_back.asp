			...
			<div class="lp-content">
				<form action="">
					...
					<ul class="order-moveType">
						<li>
							<label class="ui-radio" onclick="after_control_new('D'); setScreen();">
								<img src="/images/common/ui_radio_<%If order_type = "D" Then%>on<% else %>out<% end if %>.png" id="orderType_img_D" class="addr_img_obj_class nono">

								<input type="radio" name="orderType" onclick="after_control()" value="D"<%If order_type = "D" Then%> checked="checked"<%End If%> style="display:none">
								<span style="display:none"></span> 배달주문
							</label>
						</li>
						<li>	
							<label class="ui-radio" onclick="after_control_new('P');setScreen();">
								<img src="/images/common/ui_radio_<%If order_type = "P" Then%>on<% else %>out<% end if %>.png" id="orderType_img_P" class="addr_img_obj_class nono">

								<input type="radio" name="orderType" onclick="after_control()" value="P"<%If order_type = "P" Then%> checked="checked"<%End If%> style="display:none">
								<span style="display:none"></span> 포장주문
							</label>
						</li>
					</ul>
					<!-- //주문 방법 선택 -->
												...
												<div class="box">
													<div class="name">
														<%If aRs("is_main") = "Y" Then%>
															<span class="red">[기본배달지]</span>
														<% end if %>
													</div>

													<ul class="info">
														<li><%=aRs("zip_code")%></li>
														<li><%=aRs("address_main")&" "&aRs("address_detail")%></li>
													</ul>
													<ul class="btn-wrap">
														<li><button type="button" onclick="addr_img_control('<%=aRs("addr_idx")%>')" class="btn_middle btn-redLine btn-redChk">선택</button></li>
													</ul>
												</div>

...
<input type="hidden" id="CART_IN_PRODIDX">
			...
			<section class="section section_orderDetail pad-t0" id="cart_list">
				...
				<div class="mar-t40">
					<button type="button" onclick="openOrderType();" class="btn btn-lg btn-red w-100p order_way"> 주문방법 선택하기 </button>
				</div>
				...
				<%	Else %>
				<div class="mar-t40">
					<button type="button"  onclick="openLogin('mobile');"  class="btn btn-lg btn-red w-100p"> 비비큐 로그인 </button>
				</div>
				<%End If%>

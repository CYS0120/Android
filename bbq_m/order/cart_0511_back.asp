	...
	<div class="container">
		...
		<article class="content">
			...
			<div class="page_title">
				<img src="/images/order/icon_cart.png">
				<span>장바구니</span>
				<span class="nono all-del" id="cart_all_del" onclick="cart_all_clear_del()" style="cursor:pointer">전체삭제</span>
			</div>
			...
			<section class="section_orderDetail">
				...
				<div class="alignC mar-t25">
					<button type="button" onclick="location.href='/menu/menuList.asp';" class="btn btn_small btn-gray btn_pluse">추가하기</button>
				</div>
				...
				<div class="cart_btn">
					<%If CheckLogin() Then%><% else %><button type="button"  onclick="openLogin('mobile');"  class="btn btn-white btn_middle">로그인</button><%End If%>
					...
					<button type="button"  onclick="goOrder()"  class="btn btn-red btn_middle">결제하러 가기</button>
				</div>

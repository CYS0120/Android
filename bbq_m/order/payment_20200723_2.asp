...
<%
	...
	paycoin_start_date = "2020-07-24" ' 2020-07-24
	paycoin_end_date = "2020-07-31" ' 2020-08-01
		...
		<article class="content inbox1000">
			...
			<div class="section-wrap section-payment">
				...
				<div class="area border">
					...
					<dl>
						<dt>
							<span>포인트 <em>( 사용가능 포인트 : <strong><%=FormatNumber(resOGLFO.mTotalPoint,0)%>P</strong> )</em></span>
						</dt>
						<dd>
...
%>
			...
			<div class="section-wrap section-orderInfo">
				...
				<div class="order_calc border">
					...
					<div class="bot div-table">
						<dl class="tr">
							...
							<dd class="td red" id="calc_pay_amt"><%=FormatNumber(totalAmount + vDeliveryFee,0)%><span>원</span></dd>
						</dl>
					</div>
				</div>
				<div class="agree_ing">
				...
				<div class="btn-wrap one mar-t20">
					<button type="button" onclick="javascript:makeOrder();" class="btn btn_big btn-red">결제</button>
				</div>
					...
					<form action="">
						...
						<section class="section section_orderCoupon">
							<div class="section-header order_head">
								...
								<div class="fr mar-t10">( 사용가능 쿠폰 : <strong class="red"><%=ubound(resOGLFO.mCouponList)+1%> 장</strong> )</div>
							</div>
							<%
								'For i = 0 To iLen - 1
							%>

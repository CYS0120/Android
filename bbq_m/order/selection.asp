	...
	<div class="container">
		...
		<article class="content inbox1000">
			...
			<div class="selection_btn">
				...
				<a href="javascript:;" onclick="location.href='/order/delivery.asp?order_type=D'; " class="btn btn-redLine btn_big">배달주문</a>
				<a href="/order/delivery.asp?order_type=P" class="btn btn-red btn_big">포장주문</a>
			</div>

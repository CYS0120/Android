	...
	<article class="content inbox1000">
		...
		<div class="find_shopSearch search-box">
			<form class="form" id="deliverysearch_form" name="deliverysearch_form" action="delivery_search.asp">
				...
				<button type="button" class="btn-sch" onclick="deliverysearch_form.submit()"><img src="/images/order/btn_search.png" alt="검색"></button>
			</form>
			<div><a href="delivery_map.asp?order_type=<%=order_type%>" class="btn btn-gray btn_middle"><img src="/images/order/icon_location.png" alt="현 위치 기반 주소 검색"> 현 위치 기반 주소 검색</a></div>
		</div>
		<!-- // 검색 -->
...
<!-- 
 ...
 -->
					<!-- 	<div class="btn-wrap one mar-t20">
							<button type="button" class="btn btn_big btn-red" onclick="go_next_page_map('P')">매장 찾기</button>
						</div>
					</div> -->

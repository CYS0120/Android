				...
				<div class="lp-content">
					...
					<div class="privacy">
						...
						<div class="area">
							...
							가. 이용자들이 사전에 동의한 경우
							<ul class="li_style1">
								<li>제공대상 : 비비큐 법인, 비비큐몰 법인, 참숯바베큐 법인, 우쿠야 법인, 닭익는마을 법인, 올떡 법인, 소신275도씨 법인, 와타미 법인, 치킨대학, 창업센터</li>
								<li>제공하는 개인정보 항목 : 이름, 생년월일, 로그인ID, 비밀번호, 휴대전화번호, 이메일주소, 접속 로그, 쿠키, 접속 IP 정보</li>
								<li>제공정보의 이용 목적 : 서비스 제공에 관한 계약 이행 및 서비스 제공에 따른 요금 정산, 콘텐츠 제공, 물품배송 또는 청구지 등으로의 발송, 민원처리, 공지사항 전달, 신규 서비스(제품) 개발, 이벤트 및 광고성 정보 제공 및 참여기회 제공, 접속 빈도 파악, 회원의 서비스 이용에 대한 통계 등</li>
								<li>제공 정보의 보유 및 이용 기간 : 회사와 동일</li>
							</ul>

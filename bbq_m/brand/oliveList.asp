		...
		<article class="content">
			...
			<div class="tab-wrap tab-type3">
				<ul class="tab">
					...
					<li class="on"><a href="/brand/oliveList.asp"><span>올리브 이야기</span></a></li>
					<li><a href="/brand/videoList.asp"><span>영상콘텐츠</span></a></li>
				</ul>
			</div>
			<!--// Tab -->

			<!-- 이미지 텍스트 -->
			<div class="brand_bgOlive1">
				<dl>
					...
					<div class="answer">
						<div class="faqToggle">
							...
							<div class="oliveStory_faq">
								...
								<p>올리브오일에 함유된 비타민E와 프로비타민이 피부 노화를 막고, 노폐물을 배출시켜 건강한 피부를 유지하고 탈모와 임신선 발생 예방에도 도움을 준다. 또한 살균 정화능력을 갖고 있어 피부 트러블을 진정시키는 작용을 한다. </p>
							</div>
							<div class="oliveStory_faq">
								<p>암 예방에 도움을 준다</p>
				...
				<div class="box">
					...
					<div class="answer">
						<div class="faqToggle">
							...
							<div class="oliveStory_faq">
								<p>마요네즈를 만든다</p>
								<p>달갈노른자 6개와 올리브유 3큰술을 섞은 다음 아이보리색을 띠면서 살짝 굳을 때까지 저으면 올리브유 마요네즈 완성! 기호에 맞게 소금과 후춧가루로 간하면 됩니다. 성인병 예방에도 좋아요. </p>
							</div>
							<div class="oliveStory_faq">
								<p>빵에 찍어 먹는다</p>

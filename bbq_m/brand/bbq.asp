	...
	<div class="container">
		...
		<article class="content">
			...
			<div class="tab-wrap tab-type3">
				<ul class="tab">
					<li class="on"><a href="/brand/bbq.asp"><span>비비큐 이야기</span></a></li>
			...
			<section class="section section_bbqStroy">
				...
				<div class="bbqStroy_happy">
					...
					<ul class="txt-basic">
						<li>BBQ는 더 풍부한 행복을 만들기 위해<br/>고객의 입맛과 마음을 연구합니다.</li>
						<li>BBQ가 있는 곳 어디서나 행복한 만남이 이루어집니다.</li>
						<li>사회 윤리적 기업으로 책임과 역할을 다하여<br/>모두가 행복해지는 세상을 만들어가겠습니다. </li>
					</ul>
				</div>

				<div class="bbqStroy_qua">
					<dl class="bbqStroy_qua_first">
				...
				<div class="bbqStroy_gray">
					<div class="use">
						<h3>BBQ 사용규정</h3>
						<div class="logo"><img src="/images/brand/bbqstory_logo.jpg" alt=""></div>
						<dl>

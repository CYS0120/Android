...
비비큐 머거요.</p>
			...
			<section class="section section_info" data-0="top:688px;" data-688="top:0px;" data-1473="top:-785px;">
				...
				<div class="section-body">	
					<div class="inner">
						<div class="bbq-menu">
							<p class="txt01">창광식님이 좋아할만한</p>
							<p class="tit">NEW 치킨강정</p>
							<p class="txt02">이거 맛보는 건 어떨까요?</p>
							<i class="ico ico-cap delay-09s"></i>
							<div class="info-box">
								<img src="/images/main/img_menu02.jpg" alt="NEW 치킨강정">
								<div class="btn-wrap">
									<button type="button" class="btn btn-md btn-grayLine"><span>자세히보기</span></button>
									<button type="button" class="btn btn-md btn-red btn-line"><span>바로 주문하기</span></button>
								</div>
							</div>
						</div>
						<div class="bbq-enjoy">
			...
			<section class="section section_menu" data-0="top:1696px;" data-688="top:785px;" data-1473="top:0px;" data-2384="top:0px;" data-3335="top:-911px;">
				...
				<div class="section-body">	
					<div class="tab-wrap tab-layer">
						<ul class="tab">
							<li class="on"><a href="#" onclick="javascript:return false;"><span>올리브 오리지널</span></a></li>
							<li><a href="#" onclick="javascript:return false;"><span>올리브 핫스페셜</span></a></li>
							<li><a href="#" onclick="javascript:return false;"><span>올리브 통살</span></a></li>
							<li><a href="#" onclick="javascript:return false;"><span>올리브 갈릭스</span></a></li>
							<li><a href="#" onclick="javascript:return false;"><span>구이</span></a></li>
							<li><a href="#" onclick="javascript:return false;"><span>세트메뉴</span></a></li>
						</ul>
					</div>

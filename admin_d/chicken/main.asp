...
비비큐 머거요.</p>
			...
			<section class="section section_info" data-0="top:688px;" data-688="top:0px;" data-1473="top:-785px;">
				...
				<div class="section-body">
					<div class="inner">
						<div class="bbq-menu">
							<p class="txt01">BBQ 대표메뉴</p>
							<p class="tit">황금 올리브 치킨</p>
							<p class="txt02">지금 바로 주문하세요</p>
							<i class="ico ico-cap delay-09s"></i>
							<div class="info-box">
								<img src="/images/main/img_menu.jpg" alt="황금 올리브 치킨">
								<div class="btn-wrap">
									<button type="button" class="btn btn-md btn-grayLine"><span>자세히보기</span></button>
									<button type="button" class="btn btn-md btn-red-main btn-line"><span>바로 주문하기</span></button>
								</div>
							</div>
						</div>
						<div class="bbq-enjoy">
							...
							<div class="btn-wrap">
								<button type="button" class="btn btn-md btn-grayLine-main w-100p">
...
<div id="popup_main1" class="lp-wrapper">
	<!-- LP Wrap -->
	<div class="lp-wrap">

...
<div style="margin:50px 0 0 50px;">
	<button type="button" class="btn btn-md btn-grayLine" onclick="lpOpen('#popup_sample1');">알림창1</button>
	<button type="button" class="btn btn-md btn-red-main btn-line" onclick="lpOpen('#popup_sample2');">알림창2</button>
	<button type="button" class="btn btn-md btn-grayLine" onclick="lpOpen('#popup_sample3');">알림창3</button>
	<button type="button" class="btn btn-md btn-red-main btn-line" onclick="lpOpen('#popup_sample4');">알림창3</button>
</div>

<!-- Layer Popup : 알림창1 -->
<div id="popup_sample1" class="lp-wrapper">
	<!-- LP Wrap -->
	<div class="lp-wrap">
		<div class="lp-confirm">
			...
			<div class="btn-wrap">
				<button type="submit" class="btn btn-flat btn-red" onclick="lpClose(this);">확인</button>
			</div>
...
<!-- Layer Popup : 알림창2 -->
<div id="popup_sample2" class="lp-wrapper">
	<!-- LP Wrap -->
	<div class="lp-wrap">
		<div class="lp-confirm">
...
<!-- Layer Popup : 알림창3 -->
<div id="popup_sample3" class="lp-wrapper">
	<!-- LP Wrap -->
	<div class="lp-wrap">
		<div class="lp-confirm">
			<div class="lp-confirm-cont type2">
...
<!-- Layer Popup : 알림창4 -->
<div id="popup_sample4" class="lp-wrapper">
	<!-- LP Wrap -->
	<div class="lp-wrap">
		<div class="lp-confirm">
			<div class="lp-confirm-cont type2">

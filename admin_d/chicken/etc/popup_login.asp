...
<meta name="Keywords" content="로그인 팝업, BBQ치킨">
<meta name="Description" content="로그인 팝업">
<title>로그인 팝업 | BBQ치킨</title>
...
<body>
	<div class="winpop-wrap winpop-login">
		...
		<div class="winpop-footer">
			...
			<div class="login-etc">
				<dl class="find">
					<dt class="bul bul-dot">아이디 또는 비밀번호를 잊어버리셨나요?</dt>
					<dd><button type="button" class="btn btn-etc btn-grayLine">아이디/비밀번호 찾기</button></dd>
				</dl>
				<dl class="join">
					<dt class="bul bul-dot">아직 회원이 아니신가요?<em>회원가입을 하시면 더 많은 혜택을 받으실 수<br>있습니다.</em></dt>

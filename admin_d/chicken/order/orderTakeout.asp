			...
			<div class="section-item">
				...
				<table class="tbl-write">
					...
					<tbody>
						...
						<tr>
							<th scope="row">픽업매장주소</th>
							<td>(01234) 서울특별시 관악구 난리로66 무슨빌딩 5층</td>
						</tr>
						<tr>
							<th scope="row">기타요청사항</th>
							<td><input type="text" placeholder="방문인 이름 및 요청사항을 남겨주세요." class="w-600"></td>
						</tr>
					</tbody>
				</table>
			</div>
				...
				<table class="tbl-write">
					...
					<tbody>
						<tr>
							<th scope="row">쿠폰</th>
							<td>
								<span class="display-ib w-300"><input type="text" value="0" readonly class="w-260"> 원</span>
								<button type="button" class="btn btn-md3 btn-brownLine" onclick="javascript:lpOpen('.lp_paymentCoupon');">쿠폰적용</button>
								 &nbsp;&nbsp;
								사용가능 쿠폰 : <strong>2</strong>장
							</td>
						</tr>
						<tr>
							<th scope="row">포인트</th>
							<td>
								<span class="display-ib w-300"><input type="text" value="0" class="w-260"> P</span>
								<button type="button" class="btn btn-md3 btn-brownLine">전액사용</button>
								 &nbsp;&nbsp;
								사용가능 포인트 <strong>5,000</strong>P
							</td>
						</tr>
						<tr>
							<th scope="row">비비큐카드</th>
							<td>
								<span class="display-ib w-300"><input type="text" value="0" class="w-260"> 원</span>
								<button type="button" class="btn btn-md3 btn-brownLine" >전액사용</button>
								 &nbsp;&nbsp;
								남은금액 <strong>10,000원</strong>
							</td>
						</tr>
						<tr>
							<th scope="row">비비큐카드</th>
					...
					<tbody>
						<tr>
							...
							<td>
								...
								<button type="button" class="btn btn-md3 btn-red va-m">인증번호 전송</button>
							</td>
						</tr>
						<tr>
							<th scope="row">- 인증 번호</th>
							<td>
								<input type="text" class="w-350 va-m mar-r10">

								<button type="button" class="btn btn-md3 btn-black va-m">확인</button>
							</td>
						</tr>
					</tbody>
				</table>
						...
						<div class="td lef">
							...
							<div class="payment_choice">
								<dl class="online">
									...
									<dd>
										<ul>
											<li><button type="button" class="payment_choiceSel on"><span>신용카드</span></button></li>
											<li><button type="button" class="payment_choiceSel"><span>휴대전화 결제</span></button></li>
											<li><button type="button" class="payment_choiceSel"><span>간편 결제</span></button></li>
										</ul>
									</dd>
								</dl>
								<dl class="spot">
									...
									<dd class="spot-list">
										<ul>
											<li><button type="button" class="payment_choiceSel"><span>신용카드</span></button></li>
											<li><button type="button" class="payment_choiceSel"><span>현금</span></button></li>
										</ul>
									</dd>
								</dl>
							</div>
						...
						<div class="td rig">
							<div class="order_calc">
								<div class="top div-table">
									...
									<dl class="tr">
										<dt class="td">할인금액
										</dt><dd class="td">-5,000원</dd>
									</dl>
								</div>
								<div class="bot div-table">
									<dl class="tr">
										<dt class="td">최종 결제금액</dt>
										<dd class="td"><strong class="red">15,000</strong><span>원</span></dd>
									</dl>
								</div>
							</div>
							...
							<div class="mar-t20">
								<button type="submit" class="btn btn-lg btn-red w-100p">결제</button>
							</div>
						...
						<div class="lp-container">
							...
							<div class="lp-content">
										...
										<div class="order_menu order_lpCoupon">
											...
											<div class="mar-t25">
												<select name="" id="" class="w-100p">
													<option value="">NEW포테이토 구매시 5,000원 할인</option>
												</select>
											</div>
											<div class="sale div-table mar-t20">
												<dl class="tr">
													<dt class="td">할인금액</dt>
													<dd class="td"><span class="red">-5,000</span>원</dd>
												</dl>
											</div>
										</div>
								...
								<div class="btn-wrap two-up mar-t20">
									<button type="submit" class="btn btn-lg btn-red"><span>적용</span></button>
					...
					<div class="lp-con">
						...
						<div class="lp-container">
							...
							<div class="lp-content">
								...
								<!-- 카드선택리스트 -->
								<div class="lp_cardGift_list">
									<div class="box">
										<div class="img"><img src="/images/mypage/@card1.png" alt=""></a></div>
										<div class="info">
											<label class="ui-checkbox">
												<input type="checkbox">
												<span></span> 카드잔액 : <strong>8,000</strong>원
											</label>
										</div>
									</div>
									<div class="box">

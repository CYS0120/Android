			...
			<div class="section-wrap">
				<section class="section section_orderDetail">
					<ul class="head">
						...
						<li class="right"><img src="/images/mypage/ico_order_basic.png" alt=""> <span class="red">일반주문</span> <img src="/images/mypage/ico_order_ok.png" alt=""> <span>배달완료</span></li>
					</ul>
					<div class="order_menu">
						<div class="box div-table">
							<div class="tr">
								<div class="td img"><img src="http://placehold.it/160x138?text=1" alt=""></div>
								<div class="td info">
									<div class="sum">
										<dl>
											<dt>황금 올리브 치킨</dt>

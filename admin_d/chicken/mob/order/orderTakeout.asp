...
<meta name="Description" content="주문/결제">
		...
		<article class="content content-gray">
			...
			<div class="section-wrap section-orderInfo">
				...
				<div class="area">
					...
					<dl>
						<dt>기타요청사항</dt>
						<dd><input type="text" placeholder="방문인 이름 및 요청사항을 남겨주세요." class="w-100p"></dd>
					</dl>
				</div>
			</div>
			<!-- 배달정보 -->
			...
			<div class="section-wrap section-orderInfo">
				<div class="section-header order_head">
					<h3>쿠폰 및 포인트,비비큐 카드 사용</h3>
				</div>
				<div class="area">
					<dl>
						<dt class="point_use">
							<span>쿠폰</span>
							<em>사용가능 쿠폰 : <strong>2</strong>장</em>
						</dt>
						<dd>
							<ul class="ui-pointUse">
								<li class="lef"><input type="text" class="w-100p"></li>
								<li class="rig">
					...
					<dl>
						<dt class="point_use">
							<span>포인트</span>
							<em>사용가능 포인트 : <strong>5,000P</strong></em>
						</dt>
						<dd>
							<ul class="ui-pointUse">
								<li class="lef"><input type="tel" value="5,000" class="w-100p"></li>
								<li class="rig">
									<button type="button" class="btn btn-md w-100p btn-grayLine">전액 사용</button>
								</li>
							</ul>
						</dd>
					</dl>
					<dl>
						<dt class="point_use">
							<span>비비큐 카드</span>
							<em>남은 금액: <strong>10,000</strong></em>
						</dt>
						<dd>
							<ul class="ui-pointUse">
								<li class="lef"><input type="text" value="" class="w-100p"></li>
								<li class="rig">
									<button type="button" class="btn btn-md w-100p btn-grayLine">전액 사용</button>
								</li>
							</ul>
					...
					<dl>
						<dt class="point_use">
							<span>비비큐 카드</span>
							<em>남은 금액: <strong>12,000</strong></em>
						</dt>
						<dd>
							<ul class="ui-pointUse">
								<li class="lef"><input type="text" value="" class="w-100p"></li>
			...
			<div class="section-wrap section-orderInfo">
				...
				<div class="payment_choice">
					<dl class="online">
						...
						<dd>
							<ul>
								<li><button type="button" class="payment_choiceSel on">신용카드</button></li>
								<li><button type="button" class="payment_choiceSel">휴대전화 결제</button></li>
								<li><button type="button" class="payment_choiceSel">간편 결제</button></li>
							</ul>
						</dd>
					</dl>
					<dl class="spot">
						...
						<dd>
							<ul>
								<li><button type="button" class="payment_choiceSel">신용카드</button></li>
								<li><button type="button" class="payment_choiceSel">현금</button></li>
							</ul>
						</dd>
					</dl>
				</div>
						...
						<form action="">
							...
							<section class="section section_orderDetail pad-t20">
								<div class="section-header order_head mar-b0">
									...
									<div class="fr txt-basic black mar-t10">사용가능 쿠폰 : <strong>2</strong>장</div>
								</div>
			...
			<!-- Layer Popup : 쿠폰등록 및 적용 -->
			<div id="LP_cardSel" class="lp-wrapper lp_cardSel">
				<!-- LP Header -->
				<div class="lp-header">
					<h2>카드선택</h2>
				</div>
				...
				<div class="lp-container">
					...
					<div class="lp-content">
						...
						<div class="lp_cardGift_list">
							...
							<div class="box">
								<div class="img"><img src="/images/mypage/@card2.png" alt=""></a></div>
								<div class="info">
									<label class="ui-checkbox">
										<input type="checkbox">
										<span></span> 카드잔액 : <strong>8,000 </strong>원
						...
						<div class="btn-wrap two-up inner mar-t20">

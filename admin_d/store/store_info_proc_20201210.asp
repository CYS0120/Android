...
<%
	...
	Sql = "	Update bt_branch Set branch_type_code='"& branch_type_code &"', branch_seats='"& branch_seats &"', branch_services_code='"& branch_services_code &"', branch_weekday_open='"& branch_weekday_open &"', branch_weekday_close='"& branch_weekday_close &"', delivery_code='"& delivery_code &"', close_day_code='"& close_day_code &"', close_day='"& close_day &"', membership_yn_code='"& membership_yn_code &"', order_yn='"& order_yn &"', coupon_yn='"& coupon_yn &"', yogiyo_yn='"& yogiyo_yn &"', happy_yn_code='"& happy_yn_code &"', danal_h_cpid='"& danal_h_cpid &"', danal_h_scpid='"& danal_h_scpid &"', payco_seller='"& payco_seller &"', payco_cpid='"& payco_cpid &"', payco_itemcd='"& payco_itemcd &"', paycoin_cpid='"& paycoin_cpid &"', sgpay_merchant='"& sgpay_merchant &"', newbranch_title='"& newbranch_title &"', newbranch_explan='"& newbranch_explan &"', img_path='"& img_path &"', owner_img='"& owner_img &"', branch_thumb='"& branch_thumb &"', branch_img='"& branch_img &"', newbranch_img='"& newbranch_img &"', owner_greeting='"& owner_greeting &"', delivery_fee='"& delivery_fee &"', way_to_go='"& way_to_go &"', wgs84_x='"& wgs84_x &"', wgs84_y='"& wgs84_y &"', mod_user_idx='"& SITE_ADM_CD &"', mod_date=GetDate(), mod_ip='"& REG_IP &"', add_price_yn='"& add_price_yn &"', beer_yn='"& beer_yn &"' Where branch_id = '" & branch_id & "'"
	conn.Execute(Sql)

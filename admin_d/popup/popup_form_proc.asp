...
<%
	...
	popup_link	= InjRequest("popup_link")
	...
	If FncIsBlank(PIDX) Then
		Sql = "	Insert Into bt_popup(brand_code, popup_kind, open_sdate, open_edate, popup_width, popup_height, " & _
			"		reserve_yn, reserve_date, popup_left, popup_top, popup_close, popup_title, popup_img, popup_link,  " & _
	...
	Else
		Sql = "	Update bt_popup Set brand_code='"& brand_code &"', popup_kind='"& popup_kind &"', open_sdate='"& open_sdate &"', open_edate='"& open_edate &"', popup_width='"& popup_width &"', popup_height='"& popup_height &"', reserve_yn='"& reserve_yn &"', reserve_date='"& reserve_date &"', popup_left='"& popup_left &"', popup_top='"& popup_top &"', popup_close='"& popup_close &"', popup_title='"& popup_title &"', popup_img='"& popup_img &"', popup_link='"& popup_link &"', mod_user_idx='"& SITE_ADM_CD &"', mod_date=GetDate(), mod_ip='"& REG_IP &"' Where popup_idx = " & PIDX
		conn.Execute(Sql)

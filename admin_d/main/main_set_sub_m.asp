								...
								<th>
									<ul>
										...
										<% if CD = "A" then %>
											...
											<li><label><input type="radio" name="curpage" checked>모바일 서브 이미지 관리</label></li>
										<% end if %>
									</ul>
								</th>
							</tr>
...
<%
	...
	Sql = "Select main_kind, main_img, main_text, link_url, link_target, BAN_ORD From bt_main_img_sub_m Where brand_code='"& brand_code &"' Order By main_kind"
						...
						<tr>
							<td>
								...
								<div class="filebox">
									...
									<span>이미지 사이즈(단위:픽셀)-가로 480px, 세로 480px, 확장자 jpg <%If Not FncIsBlank(WMAINIMG1) Then%><%=WMAINIMG1%><%End If%></span>
								</div>
							</td>
						</tr>
						<tr>
						...
						<tr>
							<td>
								...
								<div class="filebox">
									...
									<span>이미지 사이즈(단위:픽셀)-가로 480px, 세로 480px, 확장자 jpg <%If Not FncIsBlank(WMAINIMG2) Then%><%=WMAINIMG2%><%End If%></span>
								</div>
							</td>
						</tr>
						<tr>
						...
						<tr>
							<td>
								...
								<div class="filebox">
									...
									<span>이미지 사이즈(단위:픽셀)-가로 480px, 세로 480px, 확장자 jpg <%If Not FncIsBlank(WMAINIMG3) Then%><%=WMAINIMG3%><%End If%></span>
								</div>
							</td>
						</tr>
						<tr>
						...
						<tr>
							<td>
								...
								<div class="filebox">
									...
									<span>이미지 사이즈(단위:픽셀)-가로 480px, 세로 480px, 확장자 jpg <%If Not FncIsBlank(WMAINIMG4) Then%><%=WMAINIMG4%><%End If%></span>
								</div>
							</td>
						</tr>
						<tr>
						...
						<tr>
							<td>
								...
								<div class="filebox">
									...
									<span>이미지 사이즈(단위:픽셀)-가로 480px, 세로 480px, 확장자 jpg <%If Not FncIsBlank(WMAINIMG5) Then%><%=WMAINIMG5%><%End If%></span>
								</div>
							</td>
						</tr>
						<tr>
						...
						<tr>
							<td>
								...
								<div class="filebox">
									...
									<span>이미지 사이즈(단위:픽셀)-가로 480px, 세로 480px, 확장자 jpg <%If Not FncIsBlank(MMAINIMG1) Then%><%=MMAINIMG1%><%End If%></span>
								</div>
							</td>
						</tr>
						<!--tr>

...
<%
	...
	Sql = "Select main_kind, main_img, main_text, link_url, link_target, BAN_ORD, date_s, date_e, date_yn From bt_main_img Where brand_code='"& brand_code &"' Order By main_kind"
						...
						<tr>
							<td>
								...
								<div class="filebox">
									...
									<span>이미지 사이즈(단위:픽셀)-가로 958px, 세로 448px, 확장자 jpg <%If Not FncIsBlank(WMAINIMG1) Then%><%=WMAINIMG1%><%End If%></span>
								</div>
							</td>
						</tr>
						<tr>
						...
						<tr>
							<td>
								...
								<div class="filebox">
									...
									<span>이미지 사이즈(단위:픽셀)-가로 958px, 세로 448px, 확장자 jpg <%If Not FncIsBlank(WMAINIMG2) Then%><%=WMAINIMG2%><%End If%></span>
								</div>
							</td>
						</tr>
						<tr>
						...
						<tr>
							<td>
								...
								<div class="filebox">
									...
									<span>이미지 사이즈(단위:픽셀)-가로 958px, 세로 448px, 확장자 jpg <%If Not FncIsBlank(WMAINIMG3) Then%><%=WMAINIMG3%><%End If%></span>
								</div>
							</td>
						</tr>
						<tr>
						...
						<tr>
							<td>
								...
								<div class="filebox">
									...
									<span>이미지 사이즈(단위:픽셀)-가로 958px, 세로 448px, 확장자 jpg <%If Not FncIsBlank(WMAINIMG4) Then%><%=WMAINIMG4%><%End If%></span>
								</div>
							</td>
						</tr>
						<tr>
						...
						<tr>
							<td>
								...
								<div class="filebox">
									...
									<span>이미지 사이즈(단위:픽셀)-가로 958px, 세로 448px, 확장자 jpg <%If Not FncIsBlank(WMAINIMG5) Then%><%=WMAINIMG5%><%End If%></span>
								</div>
							</td>
						</tr>
						<tr>
						...
						<tr>
							<td>
								...
								<div class="filebox">
									...
									<span>이미지 사이즈(단위:픽셀)-가로 958px, 세로 448px, 확장자 jpg <%If Not FncIsBlank(MMAINIMG1) Then%><%=MMAINIMG1%><%End If%></span>
								</div>
							</td>
						</tr>
						<!--tr>

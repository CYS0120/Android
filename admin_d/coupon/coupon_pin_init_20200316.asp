...
'  -------------------------------------------------------------------------------
	...
	If Len(PIN) > 0 Then
        ...
        If CD_PARTNER = "20000" Then
            ...
            Call Insert_KTR_Log("ProcUnexchange", "01", U_CD_PARTNER, BranchNM, PIN, KTR.m_StatusCode, KTR.m_ErrorCode, KTR.ErrorCode(KTR.m_ErrorCode), KTR.m_AdmitNum, KTR.m_UsedBranchCode, KTR.m_UsedBranchName, KTR.m_UsedDate, KTR.m_UsedTime, KTR.m_EventCode, "POS-"&pos, "", conn)

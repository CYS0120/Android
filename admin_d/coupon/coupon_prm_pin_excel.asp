...
<%
	...
	Sql = Sql & "		T1.CPNID, T2.CPNNAME, T1.PINID, T1.PIN, T1.CPNTYPE, T1.USESDATE, T1.USEEDATE, T1.STATUS, T1.PUBDATE, T1.USEDATE, T1.OWNERID, T1.U_CD_PARTNER AS BRANCH_ID, T1.TELNO "

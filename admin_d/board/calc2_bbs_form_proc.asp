...
<%
	...
	If MODE = "IN" Then 
		Sql = "Update bt_board_calc2 Set BSTATUS='"& BSTATUS &"', AREG_DATE=GetDate(), AREG_USER_IDX='"& SITE_ADM_CD &"', ACONTENTS='"& ACONTENTS &"', AREG_IP='"& REG_IP &"' Where BIDX=" & BIDX
		conn.Execute(Sql)
	...
	ElseIf MODE = "DEL" Then 
		Sql = "Update bt_board_calc2 Set BSTATUS='"& BSTATUS &"', AREG_DATE=null, AREG_USER_IDX=null, ACONTENTS=null, AREG_IP=null Where BIDX=" & BIDX
		conn.Execute(Sql)
		Response.Write "Y^적용되었습니다."
		Response.End
	Else

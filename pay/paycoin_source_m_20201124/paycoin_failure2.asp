...
<%
	...
	dev_msg = "취소"
	Sql = "Insert Into bt_order_g2_log(order_idx, payco_log, coupon_amt, log_point) values('"& paycoin_order_idx &"','"& Replace(returncode,"'","") &"/"& Replace(returnmsg,"'","") &"/"& Replace(dev_msg,"'","") &"','0','paycoin_failure2-001')"
	dbconn.Execute(Sql)
%>
<meta charset="utf-8">
<script>

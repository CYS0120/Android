...
<%
	...
	If tid <> pay_transaction_id Then
		Response.write "FAIL|TID 불일치 || tid= " & tid & " || bp_payment= " & pay_transaction_id
		Response.end
	End If
...
'	Next
	...
	IF RES_DATA.Item("RETURNCODE") = "0000" or RES_DATA.Item("RETURNCODE") = "1115" or RES_DATA.Item("RETURNCODE") = "3121" Then

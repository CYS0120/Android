<%@ page language="C#" autoeventwireup="true" inherits="target, App_Web_target.aspx.cdcab7d2" %>
    ...
    <form action="<%=success_url%>" name="frm1" method="post">
        <div>
            <table>
                ...
                <tr>
                    <td>
                        <input type="hidden" name="net_db_yn" value="<%=r_net_db_yn%>" />
                    </td>
                </tr>
                <tr>
                    <td>
                        <input type="hidden" name="product" value="<%=r_product%>" />
                    </td>
                </tr>
                <tr>
                    <td>

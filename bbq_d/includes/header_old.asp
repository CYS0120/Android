		...
		<header class="header">
			...
			<div class="gnb-wrap">	
				<ul class="familyBrand">
					<li class="on"><a href="http://all.fuzewire.com:8021">BBQ치킨</a></li>
					<li><a href="http://bbq.firstmall.kr/" target="_blank">비비큐몰</a></li>
					<li><a href="http://all.fuzewire.com:8022" target="_blank">닭익는마을</a></li>
					<li><a href="http://all.fuzewire.com:8023" target="_blank">참숯바베큐</a></li>
					<li><a href="http://all.fuzewire.com:8024" target="_blank">우쿠야</a></li>
					<li><a href="http://all.fuzewire.com:8025" target="_blank">올떡</a></li>
					<li><a href="http://all.fuzewire.com:8026" target="_blank">소신275°C</a></li>
					<li><a href="http://all.fuzewire.com:8027" target="_blank">와타미</a></li>
					<li><a href="http://all.fuzewire.com:8028">행복한집밥</a></li>
...
%>
					...
					<li class="node1"><a href="/event/eventList.asp" class="depth1">이벤트</a>
						<ul class="submenu">
							<li class="node2"><a href="/event/eventList.asp" class="depth2">진행중인 이벤트</a></li>
							<li class="node2"><a href="/event/eventList.asp" class="depth2">지난 이벤트</a></li>
						</ul>
					</li>
		...
		<div class="bg-lnb" style="height:250px;"></div>
	</div>

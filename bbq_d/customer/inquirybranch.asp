...
%>
	<tr>
		<th colspan="3">검색어를 두자 이상 입력해 주세요.</th>
	</tr>
<%
		Response.End 
	End If 
...
%>
	<tr>
		<th><%=BRANCH_NAME%></th>
		<td class="ta-l"><%=BRANCH_ADDRESS%></td>
		<th> <button type="button" onclick="javascript:SetStore('<%=BRANCH_ID%>','<%=BRANCH_NAME%>');" class="btn btn-sm btn-black btn_confirm"><span>확인</span></button></th>
	</tr>
<%
			vRs.MoveNext
		Loop

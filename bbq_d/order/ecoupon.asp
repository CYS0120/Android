...
<%
	...
	ecoupon_pin = GetReqStr("txtPIN", "")
	ecoupon_data = GetReqStr("ecoupon_data", "")
...
//		$("#delivery_fee").text(numberWithCommas(delivery_amt)+"원");
        ...
        // ecoupon 적용...
        // test data
        // M$$271$$0$$18000$$황금올리브치킨$$/menu_images/pc/gold_olive_chicken.jpg
        data = "M$$271$$0$$18000$$황금올리브치킨$$/menu_images/pc/gold_olive_chicken.jpg";
        //drawCartPageECoupon(data);
		//drawCartPageECoupon('<%=ecoupon_data%>');
		getView();
	});
	...
	function goOrder() {
		...
		var item = "M$$271$$0$$18000$$황금올리브치킨$$/menu_images/pc/gold_olive_chicken.jpg".split("$$");
		...
		var key = item[0]+"_"+item[1]+"_"+item[2];
		var ecoupon_data = new Object();
		ecoupon_data.key = key;
		ecoupon_data.value = jdata;

		$("#cart_form input[name=cart_value]").val("["+JSON.stringify(ecoupon_data)+"]");
	...
	function changeOrderType() {
		$("#cart_form").attr("action", "orderType.asp?couponType=Y");
		$("#cart_form").submit();
	}
</script>

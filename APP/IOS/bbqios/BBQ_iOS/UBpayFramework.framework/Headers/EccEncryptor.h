...
- (NSData   *)makeDecNoPadWithSeedkey2:(NSString *)pPlainText;
...
- (NSString *)makeEncryptedValue:(NSMutableArray *)arr;

// 보안키패드 PIN 검증
// encrypt : Base64, Sha256, SpecialChar, REV, AUTH
- (NSString *)makeDecNoPadWithSeedkey:(NSString *)pPlainText encrypt:(NSString *)encrypt;

...
- (void)setLengthWithTagName:(NSString *)pTagName length:(NSInteger)pLength; // 태그이름 길이 설정
...
- (void)setCallbackMethod:(id)pTarget
          methodOnConfirm:(SEL)pMethodOnConfirm
           ...
           methodOnReload:(SEL)pMethodOnReload;              // 콜백 메소드 설정
- (void)setCallbackMethod:(id)pTarget
          methodOnConfirm:(SEL)pMethodOnConfirm
